...
_EXPORTS = {
    ...
    "AdaptiveRecurrentRNDPPO": ("datenwissenschaften.rnd", "AdaptiveRecurrentRNDPPO"),
    "AdaptiveRecurrentRNDModel": ("datenwissenschaften.rnd", "AdaptiveRecurrentRNDModel"),
