...
_EXPORTS = {
    ...
    "RecurrentRNDPPO": ("datenwissenschaften.recurrent_rnd", "RecurrentRNDPPO"),
    "RecurrentRNDModel": ("datenwissenschaften.recurrent_rnd", "RecurrentRNDModel"),
    ...
    "build_recurrent_rnd_ppo": ("datenwissenschaften.recurrent_rnd", "build_recurrent_rnd_ppo"),
